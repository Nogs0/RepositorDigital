        ...
        <v-card class="elevation-12 pa-4">
          ...
          <v-card-text>
            ...
            <v-form @submit.prevent="handleRegister" v-model="isFormValid" ref="formRegisterUser" :loading="authStore.isLoading">
              <v-text-field v-model="formModel.username" label="Nome de usuário *" type="text"
              ...
              <v-text-field v-model="formModel.password" label="Senha *" type="password"
                ...
                :rules="[rules.required, rules.minLength(6), rules.maxLength(64)]"></v-text-field>
              <v-text-field v-model="confirmPassword" label="Confirme a senha *" type="password"
                prepend-inner-icon="mdi-lock-outline"
                :rules="[rules.required, rules.minLength(6), rules.maxLength(64), rules.passwordMatch(formModel.password)]"></v-text-field>
